...
import com.android.settings.androidx.ShortcutPickHelper.AppExpandableAdapter.GroupInfo;
...
public class ShortcutPickHelper {
    ...
    public void pickShortcut(String[] names, ShortcutIconResource[] icons, int fragmentId) {
        ...
        shortcutNames.add(mParent.getString(R.string.applist_title));
    ...
    private void processShortcut(final Intent intent, int requestCodeApplication, int requestCodeShortcut) {
        ...
        String applicationName = mParent.getString(R.string.applist_title);
